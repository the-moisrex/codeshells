...
constexpr static uint32_t R[] = {
    0x622, 0x623, 0x624, 0x625, 0x627, 0x629, 0x62f, 0x630, 0x631, 0x632, 0x648,
    0x671, 0x672, 0x673, 0x675, 0x676, 0x677, 0x688, 0x689, 0x68a, 0x68b, 0x68c,
    0x68d, 0x68e, 0x68f, 0x690, 0x691, 0x692, 0x693, 0x694, 0x695, 0x696, 0x697,
    0x698, 0x699, 0x6c0, 0x6c3, 0x6c4, 0x6c5, 0x6c6, 0x6c7, 0x6c8, 0x6c9, 0x6ca,
    0x6cb, 0x6cd, 0x6cf, 0x6d2, 0x6d3, 0x6d5, 0x6ee, 0x6ef, 0x710, 0x715, 0x716,
    0x717, 0x718, 0x719, 0x71e, 0x728, 0x72a, 0x72c, 0x72f, 0x74d, 0x759, 0x75a,
    0x75b, 0x854, 0x8aa, 0x8ab, 0x8ac};
...
int main() {
    ...
    println("R Size: {}", sizeof(R));
    println("R Length: {}", sizeof(R) / sizeof(uint32_t));
    println("L Size: {}", sizeof(L));
    println("L Length: {}", sizeof(L) / sizeof(uint32_t));
    println("D Size: {}", sizeof(D));
    println("D Length: {}", sizeof(D) / sizeof(uint32_t));
    println("All Size: {}", sizeof(D) + sizeof(L) + sizeof(R));
    println("All Length: {}",
            (sizeof(D) + sizeof(L) + sizeof(R)) / sizeof(uint32_t));
    println("All KiB: {}", double(sizeof(D) + sizeof(L) + sizeof(R)) / 1024.0l);
