...
int main() {
    ...
    string out;
    u32string inp = U"straße";
    

    println("is-valid: {}", utf32_to_punycode(inp, out));
    println("{}", out);
    println("{}", punycode_to_utf32(string_view{out.data(), out.size()}, inp));
    // println("{}", inp);
