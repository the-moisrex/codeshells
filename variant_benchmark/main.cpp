...
void voidstar(benchmark::State& state) {
  ...
  auto packages = get_random_objects<type, 50>([&] (auto r) -> type {
        switch(r) {
            case 0: return voidie{ .data= new One(), .type = 1};
            case 1: return voidie { .data = new Two(), .type = 2};
            case 2: return voidie { .data = new Three(), .type = 3};
            case 3: return voidie { .data = new Four(), .type = 4};
            default: return voidie { .data = new Three(), .type = 3};
        }
    });
  int r = 0;
  ...
  pick_randomly();
	...
	for (auto _ : state) {
		...
		switch(package->type) {
			case 1:
				res = static_cast<One*>(package->data)->get();
				break;
			case 2:
				res = static_cast<Two*>(package->data)->get();
				break;
			case 3:
				res = static_cast<Three*>(package->data)->get();
				break;
			case 4:
				res = static_cast<Four*>(package->data)->get();
				break;
			default:
				res = 100;
		}
...
void STDAny(benchmark::State& state) {
  ...
  pick_randomly();
	...
	for (auto _ : state) {
		...
		if (auto one = std::any_cast<One>(package)) {
			res = one->get();
		} else if (auto two = std::any_cast<Two>(package)) {
			res = two->get();
		} else if (auto three = std::any_cast<Three>(package)) {
			res = three->get();
		} else if (auto four = std::any_cast<Four>(package)) {
			res = four->get();
		} else {
			res = 100;
		}
...
void shared_pointer(benchmark::State& state) {
  ...
  auto packages = get_random_objects<type, 50>([&] (auto r) -> type {
        switch(r) {
        case 0: return voidie{ .data= std::make_shared<One>(), .type = 1};
        case 1: return voidie { .data = std::make_shared<Two>(), .type = 2};
        case 2: return voidie { .data = std::make_shared<Three>(), .type = 3};
        case 3: return voidie { .data = std::make_shared<Four>(), .type = 4};
        default: return voidie { .data = std::make_shared<Three>(), .type = 3};
        }
    });
  int r = 0;
  ...
  pick_randomly();
	...
	for (auto _ : state) {
		...
		switch(package->type) {
			case 1:
				res = std::static_pointer_cast<One>(package->data)->get();
				break;
			case 2:
				res = std::static_pointer_cast<Two>(package->data)->get();
				break;
			case 3:
				res = std::static_pointer_cast<Three>(package->data)->get();
				break;
			case 4:
				res = std::static_pointer_cast<Four>(package->data)->get();
				break;
			default:
				res = 100;
		}
